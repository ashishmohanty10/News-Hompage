...
import Web from "/image-web-3-mobile.jpg";
    ...
    <>
      <section className="flex flex-col md:flex-row justify-between items-start gap-5">
        ...
        <div className="w-full md:w-[70%]">
          <img src={Web3} alt="" className="hidden md:block" />
          <img src={Web} alt="" className=" md:hidden" />

          <div className="md:grid grid-cols-2 justify-between items-start my-5 gap-5">
            <div>
              <Balancer className="text-6xl font-extrabold text-left tracking-wider mb-4 md:mb-0">
